...
layouts = [
    layout.Columns(
        ...
        margin=5,  # Space between windows
    ...
    Screen(
        top=bar.Bar(
            [
                ...
                widget.WindowName(foreground="#616060", background="#171717", padding=-1, font="Fira Code Nerd Font"),
                ...
                # Right section
                widget.TextBox("", fontsize=34, padding=1, foreground="#292929", background="#0b0e0f"),
                widget.Clock(format=" %I:%M ", background="#292929", font="Fira Code Nerd Font"),

                widget.TextBox("", fontsize=34, padding=1, foreground="#171717", background="#292929"),
                widget.Clock(format=" %d/%m/%Y  ", background="#171717", font="Fira Code Nerd Font"),
                
                widget.TextBox("", fontsize=33, padding=1, foreground="#242323", background="#171717"),
                widget.Image(
                    filename="~/.config/qtile/logo.png", background="#242323",  # Path to the image
                    margin=8,  # Change image size
                ), 
            ],
            34,  # Bar height
            background="#0b0e0f",
            margin=[3, 3, 0, 3],  # Margins
